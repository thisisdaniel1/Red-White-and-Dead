...
public class CUnit : MonoBehaviour
{
    ...
    public void Initialize(Unit u, PathCreator pathCreator, float noise, float attackingFactor, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Stop)
    {
        this.noise = noise;
