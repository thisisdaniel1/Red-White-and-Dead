...
public class Archer : Unit
{
    ...
    public HashSet<Unit> unitsInRange = new HashSet<Unit>();
    ...
    private bool ShootAt(Unit targetUnit)
    {
    ...
    private void CalculateTarget(Unit targetUnit)
    {
