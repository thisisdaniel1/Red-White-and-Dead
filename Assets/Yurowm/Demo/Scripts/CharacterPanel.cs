...
public class CharacterPanel : MonoBehaviour {
	...
	Actions actions;
	CharacterRigController controller;
	Camera[] cameras;
	...
	void Initialize () {
		...
		controller = character.GetComponent<CharacterRigController> ();

		foreach (CharacterRigController.Arsenal a in controller.arsenal)
